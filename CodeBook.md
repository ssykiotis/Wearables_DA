...
The first 2 variables in the dataset indicate the test subject,ranging from 1 to 30 and the corresponding activity he is performing. The activity variable is a factor with one of the following possible values:
